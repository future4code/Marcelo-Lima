...
// Cada filme possui 3 informações essenciais: 1. nome do filme; 2. ano de lançamento e 3. gênero do 
// filme. Os gêneros da plataforma se limitam aqueles encontrados no seguinte ENUM de gêneros: 
...
function getInfoFilm(name:string, year: number, gen: GENERO, point?: number): object {
    const returnFilm: InfoFilms = {nome: name, anoLancamento: year, genero: gen, pontuacao: point}
    return returnFilm
}

console.log(getInfoFilm('Duna', 2021, GENERO.ACAO, 74))